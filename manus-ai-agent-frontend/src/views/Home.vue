  ...
  <div class="home-container">
    <div class="header">
      <div class="glitch-wrapper">
        <h1 class="glitch-title">AI Super Agent</h1>
      </div>
      <p class="subtitle">/AI, Endless Potential/</p>
    ...
    <div class="apps-container">
      <div class="app-card" @click="navigateTo('/love-master')">
        ...
        <div class="app-info">
          <div class="app-title">AI Love Guru</div>
          <div class="app-desc">Intelligent emotional advisor to help you answer your love troubles</div>
        </div>
      ...
      <div class="app-card" @click="navigateTo('/super-agent')">
        ...
        <div class="app-info">
          ...
          <div class="app-desc">All round AI assistant to solve all kinds of professional problems</div>
        </div>
        <div class="app-button">
          <span class="btn-text">Try it now</span>
          <span class="btn-icon">→</span>
...
useHead({
  title: 'AI Super Agent Application Platform - Home',
  meta: [
    {
      name: 'description',
      content: 'The AI super agent application platform provides AI love guru and AI super agent services to meet your various AI conversation needs'
    },
    {
      name: 'keywords',
      content: 'AI Agent,AI Application,AI Love Master,AI Assistant,Intelligent Conversation,Fish Skin,AI Super Agent,Home'
    }
  ]
})
